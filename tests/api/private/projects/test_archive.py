...
class TestArchiveProject:
    async def _setup(self):
        ...
        self.url = app.url_path_for('archive_project', pk=self.project.id)
    ...
    async def test_successfully_archived(self, client):
        ...
        archived_at = project.archived_at.replace(second=0, microsecond=0)
    ...
    async def test_not_found(self, client):
        pk = 100500
        url = app.url_path_for('archive_project', pk=pk)
